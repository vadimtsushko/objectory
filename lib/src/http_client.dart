...
//  int requestId = 0;
//  ObjectoryHttpImpl(this.objectoryServerUrl, Function registerClassesCallback,
//      {bool dropCollectionsOnStartup: false})
...
//  }
//
//  Future<int> doInsert(String collectionName, Map map) async {
//    int result =
//        await _postMessage(_createCommand('insert', collectionName), map);
//    return result;
//  }
//
